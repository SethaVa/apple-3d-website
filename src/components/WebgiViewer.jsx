...
const WebgiViewer = forwardRef((props, ref) => {
  ...
  const [cameraRef, setCameraReg] = useState(null);
  ...
  useImperativeHandle(ref, () => ({
    triggerPreview() {
      setPreviewMode(true);
      canvasContentRef.current.style.pointerEvents = "all";
  ...
  const handleExit = useCallback(() => {
    canvasContentRef.current.style.pointerEvents = "none";
  ...
  }, [canvasContentRef, viewerRef, positionRef, cameraRef, targetRef]);
  return (
    <div ref={canvasContentRef} id="webgi-canvas-container">
      {previewMode && (
